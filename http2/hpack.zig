...
pub const Hpack = struct {
    ...
    pub const StaticTable = struct {
        const entries = &[_]HeaderField{
            ...
            HeaderField{ .name = ":status", .value = "101" },
            ...
            HeaderField{ .name = ":status", .value = "307" },
            HeaderField{ .name = ":status", .value = "308" },
            HeaderField{ .name = ":status", .value = "400" },
            HeaderField{ .name = ":status", .value = "401" },
            HeaderField{ .name = ":status", .value = "403" },
            HeaderField{ .name = ":status", .value = "404" },
            HeaderField{ .name = ":status", .value = "405" },
            HeaderField{ .name = ":status", .value = "421" },
            HeaderField{ .name = ":status", .value = "425" },
            HeaderField{ .name = ":status", .value = "431" },
            HeaderField{ .name = ":status", .value = "451" },
            ...
            HeaderField{ .name = "alt-svc", .value = "" },
            HeaderField{ .name = "x-frame-options", .value = "" },
        };
